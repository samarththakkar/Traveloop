...
const fallbackCities = [
  ...
  { id: 4, name: 'New York', country: 'USA', region: 'Americas', budget_level: 3, avg_cost_per_day: 20000, rating: 4.8, best_seasons: ['🍂 Autumn', '❄️ Winter'], popular_for: ['🏛️ History', '🎭 Culture', '🛍️ Shopping'], description: 'The city that never sleeps, offering world-famous landmarks, Broadway shows, and diverse food scenes.', gradient: 'from-[#2c3e50] to-[#bdc3c7]', neighborhoods: ['Manhattan', 'Brooklyn', 'Queens'], image: '/new_york.jpeg', popular_activities: [{ name: 'Central Park', category: 'sightseeing', cost: 0 }, { name: 'Broadway Show', category: 'entertainment', cost: 12000 }], tips: ['Wear comfortable walking shoes', 'Try a local bagel'] },
  { id: 5, name: 'Dubai', country: 'UAE', region: 'Middle East', budget_level: 3, avg_cost_per_day: 18000, rating: 4.6, best_seasons: ['❄️ Winter', '🍂 Autumn'], popular_for: ['🏙️ Modernity', '🛍️ Shopping', '🏖️ Beach'], description: 'A city of luxury, known for ultramodern architecture, lively nightlife, and incredible shopping malls.', gradient: 'from-[#f12711] to-[#f5af19]', neighborhoods: ['Downtown Dubai', 'Palm Jumeirah', 'Dubai Marina'], image: '/dubai.jpeg', popular_activities: [{ name: 'Burj Khalifa View', category: 'sightseeing', cost: 4500 }, { name: 'Desert Safari', category: 'adventure', cost: 3500 }], tips: ['Dress modestly in public areas', 'Use the Metro during rush hours'] },
  { id: 6, name: 'Rome', country: 'Italy', region: 'Europe', budget_level: 2, avg_cost_per_day: 10000, rating: 4.9, best_seasons: ['🌸 Spring', '🍂 Autumn'], popular_for: ['🏛️ History', '🍕 Food', '🎭 Culture'], description: 'The Eternal City, home to almost 3,000 years of globally influential art, architecture, and culture.', gradient: 'from-[#603813] to-[#b29f94]', neighborhoods: ['Trastevere', 'Monti', 'Prati'], image: '/rome.jpeg', popular_activities: [{ name: 'Colosseum Tour', category: 'sightseeing', cost: 3500 }, { name: 'Authentic Pasta', category: 'food', cost: 2000 }], tips: ['Drink from the public fountains', 'Watch out for pickpockets'] },
